...
export namespace AuthServiceNs {
  ...
  export class AuthServiceClass {
    ...
    public getAuthList(id: string, platformId: number): Observable<UfastHttpAnyResModel> {
      const config: HttpUtilNs.UfastHttpConfig = {};
      config.gateway = HttpUtilNs.GatewayKey.Ius;
      return this.http.Get('/sysAuths/treeList', {id: id, platformId: platformId}, config);
    }
    ...
    public saveAuth(model: SysAuthsItemModel): Observable<UfastHttpAnyResModel> {
      const config: HttpUtilNs.UfastHttpConfig = {};
      config.gateway = HttpUtilNs.GatewayKey.Ius;
      return this.http.Put('/sysAuths/save', model, config);
    }
  }
}
