package cn.com.xgit.gw.authorization.provider;


import cn.com.xgit.gw.api.beans.CommonUserDetails;
import cn.com.xgit.gw.authorization.token.QrAuthenticationToken;
...
public class QrAuthenticationProvider extends MyAbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(String qrCode, Authentication authentication) throws AuthenticationException {
        CommonUserDetails loadedUser;
        try {
            loadedUser = (CommonUserDetails) userDetailsService.loadUserByUsername(qrCode);
